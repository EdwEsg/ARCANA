...
{
    [Route("api/get-all-items-in-sales"), ApiController]
    public class GetAllItemsForSalesTransaction : ControllerBase
    {
        private readonly IMediator _mediator;
        public GetAllItemsForSalesTransaction(IMediator mediator)
        {
            _mediator = mediator;
        }

        [HttpGet]
        public async Task<IActionResult> Get([FromQuery]GetAllItemsForSalesTransactionQuery query)
        {
            try
            {
        ...
        public class GetAllItemsForSalesTransactionQuery : UserParams, IRequest<PagedList<GetAllItemsForSalesTransactionResult>>
        {
        ...
        public class GetAllItemsForSalesTransactionResult
        {
        ...
        public class Handler : IRequestHandler<GetAllItemsForSalesTransactionQuery, PagedList<GetAllItemsForSalesTransactionResult>>
        {
            ...
            public async Task<PagedList<GetAllItemsForSalesTransactionResult>> Handle(GetAllItemsForSalesTransactionQuery request, CancellationToken cancellationToken)
            {
                ...
                var result = priceModeItems.Select(pm => new GetAllItemsForSalesTransactionResult
                {
                ...
                return await PagedList<GetAllItemsForSalesTransactionResult>.CreateAsync(result, request.PageNumber, request.PageSize);
            }
        }
    }
}
