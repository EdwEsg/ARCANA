...
{
    [Route("api/void-transaction-reports"), ApiController]
    public class VoidTransactionReports : ControllerBase
    {
        private readonly IMediator _mediator;
        public VoidTransactionReports(IMediator mediator)
        {
            _mediator = mediator;
        }

        [HttpGet]
        public async Task<IActionResult> VoidReport([FromQuery] VoidTransactionReportsQuery command)
        {
            try
            {
        ...
        public class VoidTransactionReportsQuery : IRequest<IActionResult>
        {
        ...
        public class Handler : IRequestHandler<VoidTransactionReportsQuery, IActionResult>
        {
            ...
            public async Task<IActionResult> Handle(VoidTransactionReportsQuery request, CancellationToken cancellationToken)
            {
                    ...
                    var headers = new List<string>
                {
                    ...
                    string fileName = $"Void_Transaction_Reports_{request.DateFrom:MMM d, yyyy}-{request.DateTo:MMM d, yyyy}.xlsx";
